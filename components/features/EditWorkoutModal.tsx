...
import { SPORTS, type Workout } from "@/types/workout";
import { updateWorkout } from "@/lib/firebase/workouts";
...
export function EditWorkoutModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Modifier la séance">
